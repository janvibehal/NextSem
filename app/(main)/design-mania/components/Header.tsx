...
export default function Header() {
  ...
  return (
    <div
      ...
      className="relative w-full mb-10 flex flex-col md:flex-row items-center justify-between gap-6 bg-black p-6 md:p-8 rounded-[40px] border border-zinc-800 overflow-hidden group"
    >
      {/* TEXT */}
      <div className="w-full md:w-1/2 z-10 relative">
        <h1 className="text-4xl md:text-5xl font-black text-white mb-3 tracking-tight">
          Design Mania<span className="text-zinc-500">.</span>
        </h1>
        <p className="text-zinc-400 text-lg md:text-xl leading-relaxed font-light">
          Build your system, organize your path, and design your academic journey.
        </p>
      </div>
